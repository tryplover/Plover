...
const INVALID_KEY_RE = /api.?key|invalid.?key|unauthorized|forbidden/i;
const TIMEOUT_RE = /timeout|deadline.?exceeded|request.?timed.?out/i;
const NETWORK_RE = /network|eai_again|getaddrinfo|enotfound|connect.?etimedout/i;
