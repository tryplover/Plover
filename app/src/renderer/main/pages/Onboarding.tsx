...
import { Step0Welcome } from './onboarding/components/Step0Welcome';
import { Step1Usecase } from './onboarding/components/Step1Usecase';
import { Step2Promise } from './onboarding/components/Step2Promise';
import { Step3Permission } from './onboarding/components/Step3Permission';
import { Step4Interstitial } from './onboarding/components/Step4Interstitial';
import { Step5GuidedName } from './onboarding/components/Step5GuidedName';
import { Step6GuidedBreakdown } from './onboarding/components/Step6GuidedBreakdown';
import { Step7GuidedConnect } from './onboarding/components/Step7GuidedConnect';
import { Step8GuidedProgress } from './onboarding/components/Step8GuidedProgress';
import { Step9TrialClose } from './onboarding/components/Step9TrialClose';
  ...
  return (
    <div className="plover-onboarding" data-testid="onboarding-wizard">
      ...
      <main className="plover-onboarding__body">
        {step === 0 && <Step0Welcome handleNext={handleNext} />}
        {step === 1 && (
          <Step1Usecase
            usecases={usecases}
        ...
        {step === 2 && <Step2Promise handleBack={handleBack} handleNext={handleNext} />}
        {step === 3 && <Step3Permission handleBack={handleBack} handleNext={handleNext} />}
        {step === 4 && <Step4Interstitial handleBack={handleBack} handleNext={handleNext} />}
        {step === 5 && (
          <Step5GuidedName
            appName={appName}
        ...
        {step === 6 && (
          <Step6GuidedBreakdown appName={appName} handleBack={handleBack} handleNext={handleNext} />
        )}
        {step === 7 && <Step7GuidedConnect handleBack={handleBack} handleNext={handleNext} />}
        {step === 8 && <Step8GuidedProgress handleBack={handleBack} handleNext={handleNext} />}
        {step === 9 && <Step9TrialClose handleBack={handleBack} handleFinish={handleFinish} />}
      </main>
    </div>
  );
}
