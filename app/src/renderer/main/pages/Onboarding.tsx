  ...
  return (
    <div className="plover-onboarding" data-testid="onboarding-wizard">
      ...
      <main className="plover-onboarding__body">
        ...
        {step === 2 && <Step2Promise onNext={handleNext} onBack={handleBack} />}
        {step === 3 && <Step3Permission onNext={handleNext} onBack={handleBack} />}
        {step === 4 && <Step4Interstitial onNext={handleNext} onBack={handleBack} />}
        {step === 5 && (
          <Step5GuidedName
            appName={appName}
        ...
        {step === 6 && (
          <Step6GuidedBreakdown appName={appName} onNext={handleNext} onBack={handleBack} />
        )}
        {step === 7 && <Step7GuidedConnect onNext={handleNext} onBack={handleBack} />}
        {step === 8 && <Step8GuidedProgress onNext={handleNext} onBack={handleBack} />}
        {step === 9 && <Step9TrialClose onFinish={handleFinish} onBack={handleBack} />}
      </main>
    </div>
  );
}
