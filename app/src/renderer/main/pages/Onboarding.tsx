...
import { Step1Usecases } from './onboarding/components/Step1Usecases';
...
import { Step5Name } from './onboarding/components/Step5Name';
import { Step6Breakdown } from './onboarding/components/Step6Breakdown';
import { Step7Connect } from './onboarding/components/Step7Connect';
import { Step8Progress } from './onboarding/components/Step8Progress';
  ...
  return (
    <div className="plover-onboarding" data-testid="onboarding-wizard">
      ...
      <main className="plover-onboarding__body">
        ...
        {step === 6 && <Step6Breakdown onNext={handleNext} onBack={handleBack} appName={appName} />}
        {step === 7 && <Step7Connect onNext={handleNext} onBack={handleBack} />}
        {step === 8 && <Step8Progress onNext={handleNext} onBack={handleBack} />}
