...
export function Step3Permission({ onNext, onBack }: Step3PermissionProps) {
  return (
    <section className="plover-onboarding__slide" data-testid="step-permission">
      <div className="plover-onboarding__centered">
        ...
        <div className="plover-onboarding__centered-content">
          ...
          >
            <div className="plover-onboarding__mockup-window" style={{ width: '220px', padding: '16px' }}>
              <div className="plover-onboarding__skeleton" style={{ width: '50%', marginBottom: '8px' }} />
              <div className="plover-onboarding__skeleton" style={{ width: '80%', marginBottom: '8px' }} />
              <div className="plover-onboarding__skeleton" style={{ width: '60%', marginBottom: '16px' }} />
              <div
                style={{
                  display: 'flex',
                  alignItems: 'center',
