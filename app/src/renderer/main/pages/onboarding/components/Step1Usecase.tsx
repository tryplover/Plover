    ...
    <section className="plover-onboarding__slide" data-testid="step-usecase">
      <div className="plover-onboarding__centered">
        ...
        <div className="plover-onboarding__centered-content">
          <h1 className="plover-onboarding__title--center">What tasks can Plover help you track?</h1>
          <p className="plover-onboarding__desc--center">Help Plover understand your tasks better.</p>
