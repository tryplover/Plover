...
export function Step9TrialClose({ onFinish, onBack }: Step9TrialCloseProps) {
  return (
    <section className="plover-onboarding__slide" data-testid="step-trial-close">
      <div className="plover-onboarding__centered">
        ...
        <div className="plover-onboarding__centered-content">
          ...
          <h1 className="plover-onboarding__title--center" style={{ fontSize: '48px', marginBottom: '20px' }}>
          ...
          <p className="plover-onboarding__disclaimer">You can review your plan anytime in Settings.</p>
        </div>
      </div>
    </section>
  );
