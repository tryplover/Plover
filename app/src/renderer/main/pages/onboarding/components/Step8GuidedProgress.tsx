...
export function Step8GuidedProgress({ onNext, onBack }: Step8GuidedProgressProps) {
  return (
      ...
      <div className="plover-onboarding__centered">
        ...
        <div className="plover-onboarding__centered-content">
          ...
          <div className="plover-onboarding__btn-row" style={{ justifyContent: 'center' }}>
            ...
            <button className="plover-onboarding__btn" onClick={onNext} data-testid="btn-start-working">
              Start working →
            </button>
          </div>
        </div>
