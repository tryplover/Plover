...
interface ActivityTrackingSectionProps {
  ...
  onSave: (patch: Partial<ActivitySettings>) => void;
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <Chip
            ...
            onClick={() => onSave({ pauseAllTracking: !activitySettings.pauseAllTracking })}
          >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <Chip
            ...
            onClick={() => onSave({ gdocsPollingEnabled: !activitySettings.gdocsPollingEnabled })}
          >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <Chip
            ...
            onClick={() => onSave({ fileWatchingEnabled: !activitySettings.fileWatchingEnabled })}
          >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <input
            ...
            onChange={(e) => onSave({ screenCaptureIntervalMinutes: Number(e.target.value) })}
            style={{
              width: '72px',
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <input
            ...
            onChange={(e) => onSave({ activityRetentionDays: Number(e.target.value) })}
            style={{
              width: '72px',
              backgroundColor: 'var(--plover-surface-raised)',
              border: '1px solid var(--plover-border)',
