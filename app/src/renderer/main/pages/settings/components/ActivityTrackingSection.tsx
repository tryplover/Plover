...
interface ActivityTrackingSectionProps {
  ...
  onHandleScreenCaptureToggle: (enabled: boolean) => void;
}
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <label style={{ fontSize: '14px', color: 'var(--plover-text)' }}>Window tracking</label>
          <Chip
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <Chip
            ...
            onClick={() => void onHandleScreenCaptureToggle(!activitySettings.screenCaptureEnabled)}
          >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <input
            ...
            onChange={(e) =>
              void onTriggerActivitySave({ activityRetentionDays: Number(e.target.value) })
            }
            style={{
              width: '72px',
              backgroundColor: 'var(--plover-surface-raised)',
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <Chip
            ...
            onClick={() =>
              void onTriggerActivitySave({
                planner_useRecentActivityContext: !activitySettings.planner_useRecentActivityContext,
              })
            }
          >
