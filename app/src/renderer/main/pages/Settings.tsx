...
} from './settings/components/ActivityTrackingSection';
      ...
      <div style={{ flex: 1, overflowY: 'auto', paddingRight: '40px', paddingBottom: '24px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
          ...
          <SchedulingSection
            ...
            handlePauseSchedulingToggle={handlePauseSchedulingToggle}
          />
          ...
          <ActivityTrackingSection
            ...
            triggerActivitySave={triggerActivitySave}
            handleScreenCaptureToggle={handleScreenCaptureToggle}
          />
        </div>
      </div>
    </div>
