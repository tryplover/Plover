...
interface StepTrialCloseProps {
  trialCloseMode: 'signup' | 'signin';
  setTrialCloseMode: Dispatch<SetStateAction<'signup' | 'signin'>>;
    ...
    <section className="plover-onboarding__slide" data-testid="step-trial-close">
      <div className="plover-onboarding__centered">
        ...
        <div className="plover-onboarding__centered-content">
          ...
          >
            <AuthPanel mode={trialCloseMode} onSuccess={onAuthSuccess} />
            <button
              type="button"
              className="plover-onboarding__btn-secondary"
              onClick={() => setTrialCloseMode((prev) => (prev === 'signup' ? 'signin' : 'signup'))}
              style={{
                display: 'block',
                marginTop: '12px',
                textAlign: 'center',
