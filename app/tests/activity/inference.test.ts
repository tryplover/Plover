...
function freshHarness(): {
  ...
  const engine = new InferenceEngine(tasksRepo, activityRepo, summariesRepo, settingsRepo);
  return { db, tasksRepo, goalsRepo, activityRepo, summariesRepo, settingsRepo, engine };
}
...
describe('InferenceEngine', () => {
  ...
  it('marks a task done when the server says completed=true and writes a summary', async () => {
    const { tasksRepo, goalsRepo, activityRepo, summariesRepo, settingsRepo, engine } = freshHarness();
